class Common {
    ...
    static ControllerURL = Object.freeze({
        Provider           : 'Provider',
        Customer           : 'Customer',
        Goods              : 'Goods',
        Storage            : 'Storage',
...
class EntityFilters {
    ...
    static getControllerPath(entity) {
        switch (entity) {
            case Common.EntityMap.Provider :
                return Common.ControllerURL.Provider;
            case Common.EntityMap.Customer :
                return Common.ControllerURL.Customer;
            case Common.EntityMap.Goods :
                return Common.ControllerURL.Goods;
            case Common.EntityMap.Storage :
                return Common.ControllerURL.Storage;
            case Common.EntityMap.ImportDocument :
                return Common.ControllerURL.ImportDocument;
            case Common.EntityMap.ExportDocument :
                return Common.ControllerURL.ExportDocument;
            case Common.EntityMap.ImportGoods :
                return Common.ControllerURL.ImportGoods;
            case Common.EntityMap.ExportGoods :
                return Common.ControllerURL.ExportGoods;
            case Common.EntityMap.ImportMoveDocument :
                return Common.ControllerURL.ImportMoveDocument;
            case Common.EntityMap.ExportMoveDocument :
                return Common.ControllerURL.ExportMoveDocument;
            case Common.EntityMap.AvailableGoods :
                return Common.ControllerURL.AvailableGoods;
        }
    }
...
class ListPage {
    ...
    TableLoad(callback) {
        ...
        let servlet = EntityFilters.getControllerPath(this.current_entity);
